...
const UpdateClass = () => {
  ...
  // Get the existing class details
  useEffect(() => {
  ...
  const handleUpdateClass = async (e) => {
    ...
    const { name, day, startTime, endTime } = updatedClass;
    ...
    // Debugging Line
    // console.log("Form Data:", { name, day, startTime, endTime });

    setLoading(true);

    try {
      await axiosInstance.put(`/api/classes/${id}`, {
        name,
        day,
        startTime,
        endTime,
  ...
  const handleChange = (e) => {
    ...
    // For startTime and endTime, validate format if needed
    if (
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? "Class updating..." : "Update Class"}
              </button>
            </div>
          </form>
